...
use crate::{
    glv_two_scalar_mul_online, glv_two_precompute,
    glv_two_precompute_windowed2_signed, glv_two_scalar_mul_windowed2_signed,
    PrecomputedShamir2Data, PrecomputedShamir2Table, Windowed2Signed2Data,
};
...
/// Precomputed full: v[i] = v[i] + scalar * g[i]
...
/// 2-bit signed: v[i] = v[i] + scalar * g[i]
...
/// Precomputed full: v[i] = scalar * v[i] + gamma[i]
...
/// 2-bit signed: v[i] = scalar * v[i] + gamma[i]
...
pub fn precompute_g1_generators_windowed2_signed(generators: &[G1Projective]) -> Windowed2Signed2Data {

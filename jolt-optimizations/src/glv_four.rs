...
// pub fn shamir_glv_mul_windowed2_compact(
//     windowed2_compact_table: &Windowed2CompactTable,
//     scalars: &[<Fr as PrimeField>::BigInt],
//     signs: &[bool],
// ) -> G2Projective {
//     assert_eq!(scalars.len(), 4);
...
//         // Use compact lookup if any coefficient is non-zero
//         if window_coeffs.iter().any(|&c| c != 0) {
//             let contribution = windowed2_compact_table.get_windowed2(&window_coeffs);
//             result += contribution;
//         }
//     }
